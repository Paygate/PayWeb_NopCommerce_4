    ...
    public class PayGatePaymentProcessor : BasePlugin, IPaymentMethod
    {
        ...
        public void PostProcessPayment(PostProcessPaymentRequest postProcessPaymentRequest)
        {
            ...
            using (var client = new WebClient())
            {
                ...
                initiateData["USER3"] = "nopcommerce-v4.3.0";
                ...
                if (initiated)
                {
                    ...
                    try
                    {
                        ...
                        this.defaultLogger.Information("Start write to body: " + sb.ToString());
                        response.Body.Write(data, 0, data.Length);
                        response.Body.Flush();
                        this.defaultLogger.Information("End write to body: " + sb.ToString());                        
                        //await Task.Delay(3000);
                        this.defaultLogger.Information("End three second delay: " + sb.ToString());
                    }
                    catch (Exception e)
                    {
                ...
                {
                    this.defaultLogger.Error("Failed to get valid initiate response after 5 attempts");
                }
            }
        }
